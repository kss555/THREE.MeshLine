...
// var THREE = root.THREE || has_require && require('three')
    ...
    function MeshLine() {
        ...
        this.next = [];
        this.side = [];
        // test gradient colors begin;
        this.colors = [];
        // this.alphas = [];
        // test gradient colors end;
        this.width = [];
        this.indices_array = [];
        this.uvs = [];
        this.counters = [];
...
// test gradient colors end
            ...
            '',
// test gradient color begin (uncomment next string if necessary)
